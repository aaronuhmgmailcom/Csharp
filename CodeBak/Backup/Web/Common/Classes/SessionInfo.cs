...
namespace eChartProject.Web.Common
{
    public class SessionInfo
    {
        ...
        public const string CLIENT_USER_INFO = "_client_user_info";

        public static ClientUserInfo ClientUserInfo
        {
            get
            {
                return (ClientUserInfo)HttpContext.Current.Session[CLIENT_USER_INFO];
            }
            set
            {
                HttpContext.Current.Session[CLIENT_USER_INFO] = value;
            }
        }
