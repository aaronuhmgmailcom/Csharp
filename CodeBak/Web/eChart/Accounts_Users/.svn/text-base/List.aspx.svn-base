<%@ Page Title="Accounts_Users" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="eChartProject.Web.eChart.Accounts_Users.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="FundID" HeaderText="FundID" SortExpression="FundID" ItemStyle-HorizontalAlign="Center"  /> 
